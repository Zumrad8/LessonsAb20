...
public class Main{
    ...
    методы:
    append(String s) - используется для добавления строки к уже имеющейся.
    Метод может также добавлять целые числа, float, double etc
     */
    public static void main(String[] args) {
        ...
        // replace() - заменяет исходную строку с указанной позиции заканчивая указанной позиции
