...
public class Main {
    ...
    // В теории алгоритмов рассматриваются наихудшие сценарии, то есть в нашем случае это массив, упорядоченный по
    ...
    // Если в программе имеется несколько последовательных циклов, то поведение программы определяет
    ...
    public static void main(String[] args) {
      ...
      char theta =  '\u03f4';
        ...
        0(1) - алгоритм с константным временем
        O() - сложность алгоритма О(n)
