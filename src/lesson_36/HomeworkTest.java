...
class HomeworkTest {
    ...
    public void withoutElementsEmpty(){
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNInteger(actual,5));
    }
    @Test
    ...
    public void withoutElementsNoSuchElts(){
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNInteger(actual,0));
    }
    @Test
    public void withoutElementsSeveral(){
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNInteger(actual,70));
    }
