...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // добавление элементов в конец листа, метод add() возвращает true в случае если удалось добавить это
        names.add("John");
        names.add(null);
        ...
        // Итератор
        /*
        Iterator - один из методов интерфейса Collection. Он возвращает объект,
