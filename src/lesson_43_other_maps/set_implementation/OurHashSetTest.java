...
class OurHashSetTest {
    @Test
    public void size_returnNumberOfElementsInSet(){
    ...
    @Test
    public void add_returnsFalseExistingElt(){
        OurSet<Integer>set = new OurHashSet<>();
        set.add(1);
        boolean result = set.add(1);
        assertFalse(result);
    ...
    @Test
    public void remove_returnsTrueExisting(){
        OurSet<Integer>set = new OurHashSet<>();
        set.add(1);
    ...
    @Test
    public void contains_returnsFalseForExistingElt(){
        OurSet<Integer>set = new OurHashSet<>();
        set.add(1);
